package org.formentor.magnolia.ai.infrastructure.azure.api;
...
/**
 * A request for Azure OpenAI to generate a predicted completion for a prompt.
 */
@Builder
@NoArgsConstructor
@AllArgsConstructor
...
public class CompletionRequest {
     ...
     * <p>
     * Maps tokens (specified by their token ID in the model tokenizer) to an associated bias value from -100 to 100.
     *
     */
